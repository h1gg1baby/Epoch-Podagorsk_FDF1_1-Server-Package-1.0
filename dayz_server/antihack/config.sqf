...
local _missionFiles = ["configVariables.sqf","description.ext","init.sqf","mission.sqm","rules.sqf","stringtable.xml","dayz_code\init\compiles.sqf","dayz_code\init\variables.sqf","spawn\config.sqf","spawn\init.sqf","spawn\main.sqf","spawn\functions\class_fillItems.sqf","spawn\functions\class_fillList.sqf","spawn\functions\class_pick.sqf","spawn\functions\class_preview.sqf","spawn\functions\class_randomMags.sqf","spawn\functions\class_randomTools.sqf","spawn\functions\class_wipeGear.sqf","spawn\functions\cleanup.sqf","spawn\functions\finish.sqf","spawn\functions\spawn_fill.sqf","spawn\functions\spawn_map.sqf","spawn\functions\spawn_pick.sqf"];
